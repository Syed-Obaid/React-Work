...
const QuickLinks = () => {
  ...
  return (
    <>
      <section style={{backgroundImage:"url('/public/background_image_2.jpg')"}} className="py-12 mx-auto bg-cover bg-center bg-no-repeat">
            ...
            {quickLinks.map((link) => (
              ...
              >
                <div className={`w-30 h-30 flex justify-center items-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 ${link.imageClass}`}>
                  <img className='w-14 h-14 ' src="/public/orders_notification_icon.png" alt="" />
                </div>
